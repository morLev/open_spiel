...
_EDGES = [None, 0.0, 1.0, 2.0]

_POINTS_FOR_DOMINO = 3.
...
_GAME_TYPE = pyspiel.GameType(
    short_name="python_block_dominoes_6",
    long_name="Python block dominoes_6",
...
_GAME_INFO = pyspiel.GameInfo(
    ...
    # first player hand: (2,2) (2,1)
    # second player hand is empty. can be reduced.
    min_utility=-(5 + _POINTS_FOR_DOMINO),
    max_utility=5 + _POINTS_FOR_DOMINO,
