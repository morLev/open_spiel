...
_EDGES = [None, 0.0, 1.0, 2.0, 3.0]

_POINTS_FOR_DOMINO = 5.
...
_GAME_TYPE = pyspiel.GameType(
    short_name="python_block_dominoes_10",
    long_name="Python block dominoes 10",
...
_GAME_INFO = pyspiel.GameInfo(
    ...
    # first player hand: (3, 3) (3, 2) (2, 2)
    # second player hand is empty. can be reduced.
    min_utility=-(15 + _POINTS_FOR_DOMINO),
    max_utility=15 + _POINTS_FOR_DOMINO,
